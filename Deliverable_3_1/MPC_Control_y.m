classdef MPC_Control_y < MPC_Control
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc, Ts, H)
            ...
            title('Terminal set of Controller y projected onto (1,2)')
            figure;
            Xf.projection(2:3).plot();
            title('Terminal set of Controller y projected onto (2,3)')
            figure;
            Xf.projection(3:4).plot();
            title('Terminal set of Controller y projected onto (3,4)')
